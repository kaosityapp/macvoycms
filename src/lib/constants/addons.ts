/**
 * Registration add-ons (spec §5 field 11). Stored per selection into
 * `order_items` as a one-time charge.
 */
...
export const ADDON_OPTIONS: AddonOption[] = [
  ...
  { value: 'socks', label: 'Socks', itemType: 'socks', amount: 20 },
  { value: 't-shirt+socks', label: 'T-shirt + Socks', itemType: 't-shirt+socks', amount: 40 },
];

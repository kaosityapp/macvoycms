...
By clicking "agree," I authorize MacVoy School of Irish Dance, through its payment processor, Helcim, to securely store my selected payment method and charge my credit card or debit my bank account by pre-authorized debit (PAD, labelled "ACH" within the payment platform) for tuition according to the amounts, frequency, and payment dates disclosed in my selected payment plan. Bank-account payments are also subject to the separate PAD agreement accepted during payment setup. Any additional charges require applicable authorization and notice.

I am responsible for maintaining valid payment information and sufficient funds or available credit. Declined, returned, or otherwise unsuccessful payments do not cancel my enrolment or relieve me of amounts owing. Late fees continue to apply to overdue balances under the school's fee policy, including when an automatic payment fails.

I may cancel recurring payment authorization by notifying MacVoy School of Irish Dance directly in writing, subject to the applicable payment agreement. Cancelling automatic payments does not constitute withdrawal from the program or cancel amounts otherwise owing under the enrolment agreement. I remain responsible for arranging an alternative payment method.`,
  },
];

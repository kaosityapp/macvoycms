  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      <p className="mt-3 text-brand-ink/70">
        Send us a message below, visit our social media pages, or email us directly.
      </p>

      <div className="mt-10 grid gap-8 sm:grid-cols-2">
        <div className="rounded-lg border border-brand-ink/10 bg-white p-6 shadow-sm">
          <h2 className="font-semibold text-brand-ink">Send a message</h2>
          <div className="mt-4">
            <ContactForm />
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="rounded-lg border border-brand-ink/10 bg-white p-6 shadow-sm">
            ...
            <a
              href="mailto:macvoyirishdance@rogers.com"
          ...
          <div className="rounded-lg bg-brand-pink/5 p-6 text-center">
